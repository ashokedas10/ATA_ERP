...
<!--BODY START-->
<table   style="width:94%;page-break-after: always" cellpadding="0" cellspacing="0"  >
	 ...
	 <?PHP if($header_print_status=='YES'){ ?>
		...
		<td align="center"  colspan="<?php echo $gst_colspan; ?>">
			...
			<tr ><td align="center" colspan="2">Credit Note</td></tr>
			...
			<tr>
				...
				<td >
					   ...
					   <strong>Credit Note No:</strong><?php echo $invoice_no;?>;
