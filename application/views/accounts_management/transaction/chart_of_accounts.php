				...
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-12">
							...
							<span class="glyphicon glyphicon-info-sign"></span>Chart of Account {{formname}}</h4>
						</div>
					</div>
				</div>
			</div>	
								...
								<!--GRID BODY SECTION-->								
									...
									<table  class="table table-condensed nopadding"  style="overflow:auto">
												...
												[0,FormInputArray[0]['header'][header_index]['fields'].length] | toRange">
													...
													<td ng-if="FormInputArray[0]['header'][header_index]['fields'].length!= $index">
													<button type="button" class="btn btn-success" id="Save" 
													name="Save" ng-click="chart_of_account_values(FormInputArray[0]['header'][header_index]['fields'][field_index]['id']['Inputvalue'])">Values</button>
													</td>
						 ...
						 <div ng-if="steps['InputType'] == 'LABEL'">
						   <input id="Input" autofocus type="text" name="Input"   placeholder="{{steps.LabelName}}"  
							...
							autocomplete="off"  style="width:{{50*steps.DIVClass}}px;"   readonly=""/>
													...
													<button type="button" class="btn btn-success" id="Save" 
													name="Save" ng-click="chart_of_account_values_save()">Save</button>
													</td>
