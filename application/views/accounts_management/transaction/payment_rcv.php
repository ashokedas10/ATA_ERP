			...
			<div class="panel panel-default form-group form-group-sm">		
				...
				<div  ng-repeat="header_index in [0,FormInputArray[0]['header'].length] | toRange"   id="maindiv" >	
					...
					<!--<div class="panel panel-danger"   >		
							<div class="panel-heading">
								<div class="row">
									<div class="col-sm-12">
										<h4 class="panel-title" id="contactLabel">
										<span class="glyphicon glyphicon-info-sign"></span>- - - - - - - - - - - -  - - -  - </h4>
									</div>
								</div>
							</div>
						</div>	-->
					...
					<!--	<div  ng-repeat="field_index in [0,FormInputArray[0]['header'][header_index]['fields'].length] | toRange"   >
						...
						<div   ng-if="header_index ==1" class="col-sm-6">
							<div class="box box-success">
							
							<div class="with-border box-header" ng-if="current_form_report =='payment_rcv'"><strong>Supplier Section</strong></div>
							<div class="with-border box-header" ng-if="current_form_report =='receive_amt'"><strong>Customer Section</strong></div>
						...
						<div   ng-if="header_index ==2" class="col-sm-6">
							<div class="box box-success">
							<div class="with-border box-header"><strong>Bank</strong></div>
					...
					<!--GRID ENTRY -->		
						...
						<div  ng-if="FormInputArray[0]['header'][header_index]['section_type']== 'GRID_ENTRY'">	
								<!--GRID BODY SECTION-->								
									...
									<div class="box box-success">
									<div class="with-border box-header"><strong>List of Invoice</strong></div>
