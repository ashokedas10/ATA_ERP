...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCeqM3GrjjY-AX0Mm4iAKG1kG7aGbrQBQk'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "22.6383405,88.3435167";	
	...
	var $clusterMinimumClusterSize	= 1;						// The minimum number of markers to be in a cluster before the markers are hidden and a count is shown
	...
	var $placesRadius				= 10000;						// The radius (in meters) if search is based around a central position
	...
	function get_lat_long_from_address($address, $attempts = 0)
	{
		...
		$data_location .= "maps.google.com/maps/api/geocode/json?key=".$this->apiKey."&address=".urlencode(utf8_encode($address))."&sensor=".$this->sensor;
