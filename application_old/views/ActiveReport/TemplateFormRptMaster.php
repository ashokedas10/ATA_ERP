		 ...
		 <table  class="srstable" style="width:100%">
		   ...
		   <tr>
             ...
             <td  width="45%" class="srscell-body">
			  ...
			  value="<?php echo $DataFields; ?>"  name="DataFields"  style="width:600px;"   />
		    ...
		    <tr>
			 ...
			 <td  width="18%" class="srscell-head-lft">Grid header</td>
             <td  width="45%" class="srscell-body">
			   <input type="text" id="GridHeader" 
			  value="<?php echo $GridHeader; ?>"  name="GridHeader"  style="width:600px;"   />
		   ...
		   <tr>
             <td width="15%" class="srscell-head-lft">Parent Form Name</td>
             <td width="22%" class="srscell-body"> 
			...
			$records = $this->projectmodel->get_records_from_sql($records);		
             ...
             <td  width="18%" class="srscell-body" colspan="2">
			 Parent table Field:<input type="text" id="parent_table_field_name" class="srs-txt"	
