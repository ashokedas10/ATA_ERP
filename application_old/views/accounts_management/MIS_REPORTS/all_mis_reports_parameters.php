...
<?php if($REPORT_NAME=='BILL_WISE_SALE' || $REPORT_NAME=='BILL_WISE_PURCHASE' || $REPORT_NAME=='HSN_WISE_SALE' || $REPORT_NAME=='HSN_WISE_SUMMARY' 
|| $REPORT_NAME=='GST_REPORT' || $REPORT_NAME=='PRODUCT_WISE_PURCHASE' || $REPORT_NAME=='PRODUCT_WISE_SALE' || $REPORT_NAME=='TRIAL_BALANCE' 
