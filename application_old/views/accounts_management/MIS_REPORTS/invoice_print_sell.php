...
.style16 {font-size: 14px;
	...
	<?php
		...
		$no_of_item_without_footer=24;
		$no_of_item_with_footer=16;	
...
<!--BODY START-->
<table   style="width:94%;page-break-after: always" >
	 ...
	 <?PHP if($header_print_status=='YES'){ ?>
		...
		<td align="center"  colspan="<?php echo $gst_colspan; ?>">
			...
			<td  class="style13" style="height:10px;"><strong><?php echo $party_records[0]->retail_name;?></strong></td>	
			</tr>
			<tr>
				<td width="60%">
						<span class="style13">
				...
				<td >
						<span class="style13"> 
						Address: <?php echo $party_records[0]->retail_address;?><BR>	
					   <?php if($party_records[0]->GSTNO<>''){ echo '<strong>GST No :</strong>'.$party_records[0]->GSTNO.'<br>';} ?>
					   <?php if($party_records[0]->DLNO<>''){ echo '<strong>DL No :</strong>'.$party_records[0]->DLNO.'<br>';} ?>					   
...
<tr   bgcolor="#CCCCCC">
	...
	<td width="1%"  class="style12" >| </td>
	<td width="3%" align="right" class="style12"> PTR </td>
	<td width="1%"  class="style12" >| </td>
	<?php if($stockist_type=='CNF'){ ?>
	<td width="3%" align="right" class="style12"> PTS </td>
	<td width="1%"  class="style12" >| </td>
	<?php } ?>
	<td width="2%" align="right" class="style12"> Qty  </td>
	<td width="1%"  class="style12" >| </td>
	<!--<td width="2%" align="right" class="style12">Fr Qty</td>
	<td width="1%"  class="style12" >| </td>
	<td width="2%" align="right" class="style12">Rpl Qty</td>
	<td width="1%"  class="style12" >| </td>-->
	...
	?>
		...
		<td  class="style12" >| </td>
		<td class="style12" align="right"> <?php echo $row->ptr; ?> </td>
		<td  class="style12" >| </td>
		
		<?php if($stockist_type=='CNF'){ ?>
		<td class="style12" align="right"> <?php echo round($row->ptr*.9,2); ?> </td>
		<td  class="style12" >| </td>
		<?php } ?>
	
		<td align="right" class="style12"> <?php echo $row->qnty; ?> </td>
		<td  class="style12" >| </td>
		<?php /*?><td align="right" class="style12"> <?php echo $row->freeqty; ?> </td>
		<td  class="style12" >| </td>
		<td align="right" class="style12"> <?php echo $row->freeqty; ?> </td>
		<td  class="style12" >| </td><?php */?>
	...
	<?php   for($rc=1;$rc<=$no_of_das_print;$rc++){ ?>
	 ...
	 <?PHP if($gsttype=='sgst_cgst' ){ ?>
	 <tr   bgcolor="#CCCCCC"><td class="style12" colspan="26"  align="left">TERMS AND CONDITION OF SALE </td>
	 </tr>   
	 <?PHP }else{ ?>  
	 <tr   bgcolor="#CCCCCC"><td class="style12" colspan="24"  align="left">TERMS AND CONDITION OF SALE </td>
	 </tr>
