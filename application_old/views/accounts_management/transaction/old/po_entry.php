...
<div class="container" style="width:100%" ng-app="Accounts" ng-controller="dynamic_angularjs_form" ng-init="view_list(47,0,0,-1,'NA')" >
	
			
	<div  class="form-row" id="myBody" onkeypress = "shortcut()" >
			...
			<div class="panel panel-default">		
					...
					<table class="table table-bordered table-hover table-condensed" >	
						...
						<tr  style="padding-top:0px;" >
							...
							<td  align="left" >		
							 <button type="submit" class="btn btn-success" ng-click="form_data_save()">Submit</button>
					...
					<tr class="bg-success">
						...
						<!--<button type="submit" class="btn btn-success">Outside Services</button> 
						 <button type="submit" class="btn btn-success">Catalog</button> 
						  ...
						  <a data-toggle="modal" data-target="#search_modal_requisition"><button type="submit" class="btn btn-success">Search Requisition </button></a>
						  <a data-toggle="modal" data-target="#search_modal"><button type="submit" class="btn btn-success">Search PO </button></a>
		...
		<!--SEARCH REQUISITION -->		
		<div class="modal fade" id="search_modal_requisition" tabindex="-1" role="dialog" aria-hidden="true" 
		style=" width:100%;" >
		<div class="modal-dialog" role="document" style="width:800px;max-width:100%;" >
		<div class="modal-content">
				<div class="modal-header bg-primary">
				...
				<div class="modal-body">
						 <div class="box box-success">
								...
								<tr ng-repeat="field in FormInputArray[0].header[0].grid_list2">	
