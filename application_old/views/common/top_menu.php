...
if($login_status=='SUPER') {?>	   
	...
	<li class="treeview">
		...
		<li><a href="<?php echo ADMIN_BASE_URL?>Project_controller/load_form_report/requisition/acc_tran/41/"><i class="fa fa-circle-o"></i>
		Requisition</a> </li>
...
<?php if($login_status=='ADMIN' || $login_status=='SUPER') {?>	
	...
	<?php /*?><li class="header">ACTIVITY SECTION</li>
